...
// Parameter Table
function getParameterTableDef(parameters, paramType, localize, includeExample = true) {
...
// Request Body Def
function getRequestBodyDef(requestBody, schemaStyle, localize, includeExample = true) {
  if (!requestBody) {
    return;
  }
  const content = [];
...
// Response Def
function getResponseDef(responses, schemaStyle, localize, includeExample = true) {
  const respDef = [];
